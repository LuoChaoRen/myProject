...
$('.pdd2 li').mouseover(function(){
	var a = $(this).val()
	if (a==1) {
		$('#dss').attr('src','./public/img/fdb_hover.png')
	}if (a==2) {
		$('#dgwc').attr('src','./public/img/shopb.png')
	}if (a==3) {
		$('#dp').attr('src','./public/img/icon_person_hover.png')
	}
})
$('.pdd2 li').mouseout(function(){
	var a = $(this).val()
	if (a==1) {
		$('#dss').attr('src','./public/img/fdb.png')
	}if (a==2) {
		$('#dgwc').attr('src','./public/img/shopw.png')
	}if (a==3) {
		$('#dp').attr('src','./public/img/icon_person.png')
	}
})
...
$('.lista li').mouseover(function(){
	...
	if (a == 1) {
		$('#a1').attr('src','./public/img/shoujic.png')
	}
	if (a == 2) {
		$('#a2').attr('src','./public/img/erjic.png')
	}
	if (a == 3) {
		$('#a3').attr('src','./public/img/kec.png')
	}
	if (a == 4) {
		$('#a4').attr('src','./public/img/xianc.png')
	}
	if (a == 5) {
		$('#a5').attr('src','./public/img/taozhuangc.png')
	}
	if (a == 6) {
		$('#a6').attr('src','./public/img/baoc.png')
	}
})
$('.lista li').mouseout(function(){
	...
	if (a == 1) {
		$('#a1').attr('src','./public/img/shoujib.png')
	}
	if (a == 2) {
		$('#a2').attr('src','./public/img/erjib.png')
	}
	if (a == 3) {
		$('#a3').attr('src','./public/img/keb.png')
	}
	if (a == 4) {
		$('#a4').attr('src','./public/img/xianb.png')
	}
	if (a == 5) {
		$('#a5').attr('src','./public/img/taozhuangb.png')
	}
	if (a == 6) {
		$('#a6').attr('src','./public/img/baob.png')
	}
})
